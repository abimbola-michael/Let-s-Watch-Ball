...
class VlcPlayerWithControlsState extends State<VlcPlayerWithControls> {
  ...
  PlayControl? currentPlayControl;

  Stream<int>? recordingTimerStream;
            ...
            AnimatedOpacity(
              ...
              child: Container(
                ...
                child: Stack(
                  ...
                  children: [
                    Center(child: ControlsOverlay(controller: _controller)),
                    Column(
                      mainAxisSize: MainAxisSize.min,
                      children: [
                        if (currentPlayControl == PlayControl.volume)
                          Container(
                            padding:
                        ...
                        if (currentPlayControl == PlayControl.record)
                          Row(
                            mainAxisAlignment: MainAxisAlignment.center,
                            children: [
                              StreamBuilder<int>(
                                  stream: recordingTimerStream,
                        ...
                        if (currentPlayControl == PlayControl.info)
                          Padding(
                        ...
                        Row(
                          children: [
                            ...
                            IconButton(
                              ...
                              color: Colors.white,
                              onPressed: widget.onViewFullScreen,
                            ),
                          ],
                        ),
                        SizedBox(
  ...
  void toggleInfosVisibility() {
    if (currentPlayControl == PlayControl.info) {
      currentPlayControl = null;
    } else {
      currentPlayControl = PlayControl.info;
    }
    setState(() {});
  }
  ...
  void toggleVolumeVisibility() {
    if (currentPlayControl == PlayControl.volume) {
      ...
      currentPlayControl = PlayControl.volume;
    }
    setState(() {});
  }
  ...
  Future<void> _toggleRecording() async {
    if (!_controller.value.isRecording) {
      ...
      recordingTimerStream =
          Stream.periodic(const Duration(seconds: 1), (count) => count);
      currentPlayControl = PlayControl.record;
    } else {
      await _controller.stopRecording();
      recordingTimerStream = null;
      currentPlayControl = null;
    }
    setState(() {});
  }
