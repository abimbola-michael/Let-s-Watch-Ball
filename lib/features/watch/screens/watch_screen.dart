...
class _WatchScreenState extends ConsumerState<WatchScreen> {
        ...
        if (myWatcher!.status == "current" && calling) {
          if (availableWatchDuration > 0) {
            ...
            context.showSnackBar(
                "${isSubscription ? "Your subscription has expired." : "You have used up your $MAX_DAILY_LIMIT mins daily limit"} Please subscribe to continue",
                true);
            await leaveWatch(true);
            gotoSubscription();
          }
        }
  ...
  void readWatchers() async {
    ...
    webRTCCallUtils.init(watch!.watchers, watchId);
  ...
  void addNewWatchers() async {
    ...
    if (result != null) {
      ...
      if (selectedUsers.isNotEmpty) {
        addWatchers(watch!, selectedUsers, [], webRTCCallUtils.callMode);
      }
    }
  }
                    ...
                    Expanded(
                      child: Column(
                        ...
                        children: [
                          ...
                          Text(
                            calling
                                ? "Watching ${durationToString(duration)} / ${durationToString(availableWatchDuration)}"
                    ...
                    : CustomGridview(
                        ...
                        itemBuilder: (context, index) {
                          ...
                          return WatcherItem(
                            ...
                            watcher: watcher,
                            videoRenderer:
                                webRTCCallUtils.getVideoRender(watcher.id),
                            onPressed: (action) =>
                ...
                : myWatcher!.status == "request"
                    ...
                    : [
                        ...
                        CallActionButton(
                          ...
                          onPressed: webRTCCallUtils.toggleVideoAudio,
                        ),
                        ...
                        CallActionButton(
                            ...
                            onPressed: webRTCCallUtils.toggleMute),
                        CallActionButton(
                          icon: EvaIcons.phone_off,
                          selected: webRTCCallUtils.isOnHold,
                          onPressed: webRTCCallUtils.toggleHold,
                        ),
                      ],
          ),
        )
