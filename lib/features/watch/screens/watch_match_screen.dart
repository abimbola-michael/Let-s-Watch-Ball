...
//       final watch = context.args["watch"] as Watch?;
...
//           looping: false);
//     }
//     ref.read(matchProvider.notifier).updateMatch(matches[matchIndex]);
...
//     if (matches.isEmpty && currentWatch != null) {
