      ...
      children: [
        if (widget.titleText.trim().isNotEmpty)
          Text(widget.titleText,
              style: context.bodyLarge?.copyWith(color: lighterTint)),
        Container(
          width: widget.width,
          ...
          child: GestureDetector(
            ...
            child: TextFormField(
              ...
              style: widget.style ?? context.bodyLarge?.copyWith(fontSize: 17),
              ...
              decoration: InputDecoration(
                ...
                hintStyle: widget.style != null
                    ? widget.style?.copyWith(color: lightestBlack)
                    : context.bodyLarge
                        ?.copyWith(fontSize: 18, color: lightestBlack),
